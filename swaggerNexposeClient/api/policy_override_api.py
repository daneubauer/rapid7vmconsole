...
class PolicyOverrideApi(object):
    ...
    def create_policy_override(self, **kwargs):  # noqa: E501
        ...
        :param PolicyOverride param0: The specification of a policy override. Allows users to override the compliance result of a policy rule.
    ...
    def set_policy_override_expiration(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: The identifier of the policy override. (required)
        :param str param1: The date the policy override is set to expire. Date is represented in ISO 8601 format.
        :return: Links
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def set_policy_override_status(self, id, status, **kwargs):  # noqa: E501
        ...
        :param str param2: A comment describing the change of the policy override status.
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
