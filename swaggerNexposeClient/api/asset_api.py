...
class AssetApi(object):
    ...
    def create_asset(self, id, **kwargs):  # noqa: E501
        ...
        :param AssetCreate param1: The details of the asset being added or updated.  The operating system can be specified in one of three ways, with the order of precedence: `\"osFingerprint\"`, `\"os\"`, `\"cpe\"`
