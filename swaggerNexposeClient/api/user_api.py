...
class UserApi(object):
    ...
    def create_user(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param User param0: The details of the user.
    ...
    def reset_password(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: The identifier of the user. (required)
        :param str param1: The new password to set.
        :return: Links
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def set_two_factor_authentication(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: The identifier of the user. (required)
        :param str param1: The authentication token seed (key) to use for the user.
        :return: Links
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def set_user_asset_groups(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: The identifier of the user. (required)
        :param list[int] param1: The identifiers of the asset groups to grant the user access to. Ignored if user has access to `allAssetGroups`.
        :return: Links
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def set_user_sites(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: The identifier of the user. (required)
        :param list[int] param1: The identifiers of the sites to grant the user access to. Ignored if the user has access to `allSites`.
        :return: Links
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_role(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str id: The identifier of the role. (required)
        :param Role param0: The details of the role.
        :return: Links
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_user(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: The identifier of the user. (required)
        :param User param1: The details of the user.
        :return: Links
                 If the method is called asynchronously,
                 returns the request thread.
        """
